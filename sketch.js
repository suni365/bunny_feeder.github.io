...
function setup() {
  ...
  button4.position(250,50);
  button4.size(60,60);
  button4.mouseClicked(drop5);


  
  button5 = createImg('cut_btn.png');
  button5.position(70,360);
  button5.size(60,60);
  button5.mouseClicked(drop6);
  ...
  rope4 =new Rope(7,{x:240,y:40});
  rope5= new Rope(4,{x:60,y:350});

  rope6 =new Rope(7,{x:170,y:350});
  ...
  fruit_con3 =new Link(rope4,fruit);
  fruit_con4= new Link(rope5,fruit);
  fruit_con5 =new Link(rope6,fruit);
